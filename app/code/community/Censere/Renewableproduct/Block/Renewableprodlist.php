...
class Censere_Renewableproduct_Block_Renewableprodlist extends Mage_Core_Block_Template
{
...
//                ->addFieldToFilter('real_cust_id', Mage::getSingleton('customer/session')->getCustomer()->getId())
            ...
            $this->setRenewableCustList($renewableproductlist);
    ...
    protected function _prepareLayout()
    {
         ...
         * */
        $pager = $this->getLayout()->createBlock('page/html_pager', 'renewableprod.renewableprodlist.index.pager')
            ->setCollection($this->getRenewableCustList());
//
        /*
         ...
         * */
        $this->getRenewableCustList()->setPageSize($this->getLimit());

        $this->setChild('pager', $pager);

        $this->getRenewableCustList()->load();
